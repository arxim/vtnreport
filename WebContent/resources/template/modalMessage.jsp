...
<div id="sent-loading-modal" class="modal fade clsModal" role="dialog" 	data-backdrop="static" data-keyboard="false" aria-hidden="true">
	<div class="modal-dialog" style="width: 400px;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-info-title"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
...
<div id="sent-success-modal" class="modal fade clsModal" role="dialog" data-backdrop="static" data-keyboard="false" aria-hidden="true">
	<div class="modal-dialog" style="width: 400px;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-info-title"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
